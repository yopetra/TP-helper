package com.example.android.tp_helper.utils;
...
public class VerticalScrollingTextView extends TextView {
    ...
    protected void initAttributes(TypedArray attrArray) {
        String textStyle = attrArray.getString(R.styleable.MyTextView_scrollingTextStyle);
    ...
    public void scrollFrom(int offset) {
        int viewHeight = getHeight();
        int visibleHeight = viewHeight - getPaddingBottom() - getPaddingTop();
        int lineHeight = getLineHeight();
//        int offset = -1 * visibleHeight;
